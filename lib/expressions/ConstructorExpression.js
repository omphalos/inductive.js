...
function ConstructorExpression(spec) {
  var self = this
    , name = spec.name
    , functionType = spec.getType()
...
ConstructorExpression.prototype.resolveType = function() {
  var result = FunctionExpression.prototype.resolveType.apply(
    this, arguments)
  result.spec = this.spec
  return result
}

ConstructorExpression.prototype.tryFilterType = function() {
  var result = FunctionExpression.prototype.tryFilterType.apply(
    this, arguments)
