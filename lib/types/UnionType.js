  ...
  for(var c = 0; c < this.children.length; c++) {
    ...
    if(child.ctor) {
      for(var d = 0; d < this.children.length; d++) {
        ...
        if(child.isArgumentsObjectType
          && this.children[d].isArgumentsObjectType) {
...
UnionType.prototype.containsType = function(instance, typeFilters, recs) {
  ...
  var filteredType = tryFilterType.apply(this, typeFilters)
  return !filteredType.getError()
}

function tryFilterType(typeFilters, recs) {
  if(
    !typeFilters ||
...
UnionType.prototype.filterType = function(typeFilters, recs) {
  var result = tryFilterType.call(this, typeFilters, recs)
