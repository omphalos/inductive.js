...
UnionType.prototype.add = function(type) {
  ...
  for(var c = 0; c < this.children.length; c++)
    if(type.containsType(this.children[c], {}) ||
      ...
      copy.children = sortTypes(copy.children)
      return copy
    }
...
UnionType.prototype.getInstanceError = function(instance, typeFilters) {
  var allChildErrors = []
  ...
  for(var c = this.children.length - 1; c >= 0; c--) {
    var copy = util.copy(typeFilters)
      , childError = this.children[c].getInstanceError(instance, copy)
